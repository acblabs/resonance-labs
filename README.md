...
- AudioContext output priming and running-state checks before chirp scheduling so blocked or suspended browser playback produces a visible error instead of a silent upload.
